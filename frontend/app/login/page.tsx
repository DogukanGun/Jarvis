    ...
    <div className="min-h-screen bg-[#0F172A] flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-white/60">Sign in to your Jarvis account</p>
        </div>
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <Checkbox
                  ...
                  className="border-white/20 data-[state=checked]:bg-[#F7931A] data-[state=checked]:border-[#F7931A]"
                />
                <Label
                  htmlFor="remember"
              ...
              <Link
                ...
                className="text-sm text-[#FCD34D] hover:text-[#F7931A] transition-colors"
              >
                Forgot password?
              </Link>
            </div>
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-[#1e1b4b]/50 text-white/40">Or continue with</span>
              </div>
            </div>

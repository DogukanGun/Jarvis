...
Vendored from chainstacklabs/pumpfun-bonkfun-bot (Apache-2.0).
Source: https://github.com/chainstacklabs/pumpfun-bonkfun-bot/blob/main/src/trading/position.py
See ../LICENSE and ../NOTICE for license terms and modification list.
"""
...
class Position:
    ...
    # Token information
    # MOD: original used `solders.pubkey.Pubkey`; we use base58 str
    # to keep this module dep-free (see ../NOTICE).
    mint: str
    symbol: str
    ...
    def __str__(self) -> str:
        ...
        return (
            f"Position({self.symbol}: {self.quantity:.6f} @ {self.entry_price:.8f} SOL"
            f" - {status})"
        )

...
9. **legal_rag** - Legal questions: interpret statutes or articles, analyze contracts, identify liability, explain rights or obligations, compare legal provisions across jurisdictions, understand penalty provisions, procedural requirements, or any question about uploaded legal documents.

Classify the user's message and extract any arguments.

RESPOND ONLY with valid JSON in this exact format:
{{"intent": "chat|research|web_fetch|security|visual|code_analysis|solana_trade|solana_strategy|legal_rag", "tool_args": {{}}}}
...
For legal_rag: {{"intent": "legal_rag", "tool_args": {{}}}}
...
def classify_intent(state: RouterGraphState) -> Dict[str, Any]:
    ...
    if state.get("intent") in ("chat", "research", "web_fetch", "security", "visual", "code_analysis", "solana_trade", "solana_strategy", "legal_rag"):
    ...
    try:
        ...
        # Validate intent
        if intent not in ("chat", "research", "web_fetch", "security", "visual", "code_analysis", "solana_trade", "solana_strategy", "legal_rag"):
            intent = "chat"
